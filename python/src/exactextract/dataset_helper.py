...
def to_gdal_dataset_wrapper(filename_or_ds: Union[str, pathlib.Path,
                                                  gdal.Dataset,
                                                  ogr.DataSource],
    ...
    """
    Return exactextract GDALDatasetWrapper object from Python OSGeo Dataset
    ...
    # Put it all together
    return GDALDatasetWrapper(this_ds_name, this_layer_name, this_field_name)
